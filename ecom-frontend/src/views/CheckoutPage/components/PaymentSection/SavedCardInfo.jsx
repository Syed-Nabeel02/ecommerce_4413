...
import AddressFormModal from '../ShippingAddress/AddressFormModal';
...
const SavedCardInfo = ({ cards }) => {
  ...
  const handleDeleteCard = () => {
    dispatch(deleteUserPaymentCard(toast, selectedCard?.cardId, setOpenConfirmDeleteDialog));
  };
    ...
    <div className="pt-4">
      {noCardsExist ? (
        ...
        <div className="relative p-6 rounded-lg max-w-md mx-auto">
          <h1 className="text-slate-800 text-center font-bold text-2xl">Select Payment Card</h1>
      ...
      <AddressFormModal open={openCardModal} setOpen={setOpenCardModal}>
        <NewCardForm card={selectedCard} setOpenCardModal={setOpenCardModal} />
      </AddressFormModal>
      ...
      <ConfirmDeleteDialog
        ...
        onDeleteHandler={handleDeleteCard}
      />
    </div>
  );
};
